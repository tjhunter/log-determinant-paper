...
\begin{lemma}[Bernstein's inequality] \label{lem:bernstein} Let $X_{1}\cdots X_{n}$ be independent
...
then the algorithm \texttt{ApproxPreconditioned- LogDetMonteCarlo} returns
a scalar $z$ so that:
\[
