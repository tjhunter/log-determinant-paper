...
with the assumption $\lambda_{\text{\textnormal{min}}}I_{n}\preceq H\preceq\lambda_{\text{\textnormal{max}}}I$.
...
bound looks the same, the constant (taken away by the $O\left(\cdot\right)$
notation) is twice as large as in Corollary \ref{cor:preconditioning}.
