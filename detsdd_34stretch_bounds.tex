...
We will make use of this sparsification result from Spielman and Srivastava \cite{Spielman2009}:
...
$1/2$ in expected time $\tilde{O}\left(m+n\log^{3}n\log^{2}\kappa (A)\right)$
...
By construction $\kappa (H)\leq\frac{1+1/16}{1-1/16}\kappa (A)$,
hence the result.
