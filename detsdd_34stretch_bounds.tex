...
\subsection{Stretch bounds on preconditioners}
...
Note that this inequality is a stronger result than the bound $L_{H}\preceq L_{G}\Rightarrow\text{st}_{H}\left(G\right)\geq n-1$
