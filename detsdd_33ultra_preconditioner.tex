...
\begin{comment}
TODO: the newer version from Koutis2011 has a $\log^{2}n$ good chain,
but then it produces $d=\log n$ I think. See the proof of their lemma
4.5
\end{comment}
...
\begin{comment}
TODO: use the imbricated preconditioners, no need to recompute everything
every time :-)
\end{comment}
